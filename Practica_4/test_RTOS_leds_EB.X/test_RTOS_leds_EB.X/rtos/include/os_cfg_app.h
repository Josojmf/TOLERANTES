...
#define  OS_CFG_ISR_STK_SIZE             2048u              /* Stack size of ISR stack (number of CPU_STK elements)   */
#define  OS_CFG_TASK_STK_LIMIT_PCT_EMPTY   10u              /* Stack limit position in percentage to empty            */


                                                            /* ---------------------- IDLE TASK --------------------- */
#define  OS_CFG_IDLE_TASK_STK_SIZE       2048u              /* Stack size (number of CPU_STK elements)                */
...
#define  OS_CFG_INT_Q_TASK_STK_SIZE       u                 /* Stack size (number of CPU_STK elements)                */
                                                            ...
                                                            /* ------------------- STATISTIC TASK ------------------- */
#define  OS_CFG_STAT_TASK_PRIO            3u                /* Priority                                               */
#define  OS_CFG_STAT_TASK_RATE_HZ        10u                /* Rate of execution (10 Hz Typ.)                         */
#define  OS_CFG_STAT_TASK_STK_SIZE       10000u             /* Stack size (number of CPU_STK elements)                */


                                                            /* ------------------------ TICKS ----------------------- */
#define  OS_CFG_TICK_RATE_HZ            1000u               /* Tick rate in Hertz (10 to 1000 Hz)                     */
#define  OS_CFG_TICK_TASK_PRIO           2u               /* Priority                                               */
#define  OS_CFG_TICK_TASK_STK_SIZE       2048u              /* Stack size (number of CPU_STK elements)                */
#define  OS_CFG_TICK_WHEEL_SIZE           1u               /* Number of 'spokes' in tick  wheel; SHOULD be prime     */
